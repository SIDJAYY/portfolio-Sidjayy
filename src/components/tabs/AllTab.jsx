...
const ALL_POSTS = [
  ...
  },
  {
    ...
    avatar: '/profile_picture/profilepicture.jpg',
    time: 'August 20, 2026 · 🌐',
    caption: 'Designed, configured, and deployed a self-hosted **Network Video Recorder (NVR)** surveillance server utilizing **Shinobi** on a headless **Ubuntu Linux** Virtual Machine. Successfully engineered a local network infrastructure bridge to convert an Android mobile hardware device into an active network IP camera stream, resolving strict virtualization constraints and optimizing video compression processing.',
    images: [
      '/projects_picture/CCTV_UBUNTU/VBOX_CCTV1.png',
      '/projects_picture/CCTV_UBUNTU/VBOX_CCTV2.png',
      '/projects_picture/CCTV_UBUNTU/VBOX_CCTV3.png',
      '/projects_picture/CCTV_UBUNTU/VBOX_CCTV4.png',
      '/projects_picture/CCTV_UBUNTU/VBOX_CCTV5.png',
    ],
    tags: ['CCTV', 'SHINOBI', 'UBUNTU', 'Virtualization', 'IPCAMERA', 'Networking'],
    likes: 195,
    comments: [],
    shares: 18,
    isLiked: false,
