...
const ALL_POSTS = [
  ...
  },
  {
    ...
    avatar: '/profile_picture/profilepicture.jpg',
    time: 'March 15, 2025 · 🌐',
    caption: '🎉 Milestone achieved: Officially graduating as an Information Technology Specialist! Grateful for all the projects, mentorship, and tech stack experience.',
    images: [
    ...
    tags: ['IT Specialist', 'Software Engineering', 'TypeScript', 'DevTools'],
    likes: 380,
    comments: [],
    shares: 34,
    isLiked: false,
  ...
  },
  {
    ...
    avatar: '/profile_picture/profilepicture.jpg',
    time: 'August 5, 2026 · 🌐',
    caption: '🎯 INFORMATION TECHNOLOGY SPECIALIST — This is my story, my journey, and my craft. Building systems, solving problems, and pushing boundaries every single day. Open to IT opportunities! 💻🔧',
    image: '/profile_picture/background_photo.png',
    tags: ['ITSpecialist', 'WebDeveloper', 'TechSupport', 'OpenToWork'],
    likes: 88,
    comments: [
      { id: 601, author: 'Mark Santos', avatar: '/profile_picture/profilepicture.jpg', text: 'Awesome cover bro! Keep it up! 🔥', time: '2h ago' }
    ],
    shares: 7,
    isLiked: false,
    github: 'https://github.com',
  },
  {
    ...
    avatar: '/profile_picture/profilepicture.jpg',
    time: 'August 5, 2026 · 🌐',
    caption: '🎯 GRADUATION & IT CERTIFICATIONS — Officially verified Information Technology Specialist credentials and graduation milestone! 🎓📜',
    image: '/profile_picture/profilepicture.jpg',
    tags: ['Certificates', 'Graduation', 'ITSpecialist', 'Verified'],
    likes: 672,
    comments: [
